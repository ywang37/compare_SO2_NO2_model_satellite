...
! add OMPS L2 swath SO2 (ywang, 08/07/17)
#if defined (OMPS_SO2_OBS)
      USE OMPS_SO2_OBS_MOD,      ONLY : CALC_OMPS_SO2_FORCE
#endif

! add OMPS L2 swath NO2 (ywang, 05/28/18)
#if defined (OMPS_NO2_OBS)
      USE OMPS_NO2_OBS_MOD,     ONLY : CALC_OMPS_NO2_FORCE
#endif
...
!      ENDIF
      ...
      CALL CALC_OMPS_SO2_FORCE( COST_FUNC )

      ! Track cost function contributions
      CF_OMPS_SO2 = CF_OMPS_SO2 + COST_FUNC - CF_PRIOR
      ...
      CALL CALC_OMPS_NO2_FORCE( COST_FUNC )

      ! Track cost function contributions
      CF_OMPS_NO2 = CF_OMPS_NO2 + COST_FUNC - CF_PRIOR
...
!===================================================================
      ...
      CALL CALC_OMI_NO2_FORCE( COST_FUNC )

      ! Track cost function contributions
      CF_OMI_NO2 = CF_OMI_NO2 + COST_FUNC - CF_PRIOR
